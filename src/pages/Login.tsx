        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <div className="mt-12 flex gap-8">
            <div className="text-center">
              ...
              <div className="text-sm text-primary-foreground/60">Módulos</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-display text-gold">100%</div>
              <div className="text-sm text-primary-foreground/60">Estratégico</div>
            </div>
            <div className="text-center">
        ...
        <div className="w-full max-w-md animate-fade-in">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground">
              Entre com suas credenciais de consultor
            </p>
          </div>
